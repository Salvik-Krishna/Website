...
// Function to load the loading.html content
...
// Function to hide the loading animation and show the main content
function showMainContent() {
  document.getElementById('loading').style.display = 'none';
  document.getElementById('main-content').style.display = 'block';
}

// Load the loading content when the page starts loading
loadLoadingContent();

// Show the main content when the window has finished loading
window.addEventListener('load', function() {
  showMainContent();
  initLocomotiveAndGsap(); // Initialize the locomotive and GSAP animations after loading
});
